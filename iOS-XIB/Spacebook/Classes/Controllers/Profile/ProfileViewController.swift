...
class ProfileViewController: UIViewController {
    ...
    private func setupUI()  {
        ...
        self.photosCollectionView.register(UINib(nibName: "ViewCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "ViewCollectionViewCell")
        self.photosCollectionView.register(UINib(nibName: "ViewTwoCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "ViewTwoCollectionViewCell")
        self.photosCollectionView.register(UINib(nibName: "ViewThreeCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "ViewThreeCollectionViewCell")
    }
    ...
    @IBAction public func onLeftItemPressed(_ sender: UIView)  {
        let destination = ProfileSettingsViewController(nibName: "ProfileSettingsViewController", bundle: nil)
...
extension ProfileViewController: UICollectionViewDelegate  {
    ...
    public func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath)  {
        ...
        if indexPath.row % 3 == 0 {
            let destination = ProfilePhotosViewController(nibName: "ProfilePhotosViewController", bundle: nil)
            self.navigationController?.pushViewController(destination, animated: true)
        }
    }
}
