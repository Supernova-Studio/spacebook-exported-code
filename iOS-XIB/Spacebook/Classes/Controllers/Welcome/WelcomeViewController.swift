...
class WelcomeViewController: UIViewController {
    ...
    @IBAction public func onSignUpPressed(_ sender: UIButton)  {
        let destination = SignupViewController(nibName: "SignupViewController", bundle: nil)
        self.navigationController?.pushViewController(destination, animated: true)
    }

    @IBAction public func onLogInPressed(_ sender: UIButton)  {
        let destination = LoginViewController(nibName: "LoginViewController", bundle: nil)
        self.navigationController?.pushViewController(destination, animated: true)
    }
