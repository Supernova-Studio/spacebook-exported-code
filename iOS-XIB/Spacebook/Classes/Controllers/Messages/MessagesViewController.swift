...
class MessagesViewController: UIViewController {
    ...
    private func setupUI()  {
        ...
        self.messagesTableView.register(UINib(nibName: "MessageTwoTableViewCell", bundle: nil), forCellReuseIdentifier: "MessageTwoTableViewCell")
        self.messagesTableView.register(UINib(nibName: "MessageThreeTableViewCell", bundle: nil), forCellReuseIdentifier: "MessageThreeTableViewCell")
        self.messagesTableView.register(UINib(nibName: "MessageFourTableViewCell", bundle: nil), forCellReuseIdentifier: "MessageFourTableViewCell")
        self.messagesTableView.register(UINib(nibName: "MessageFiveTableViewCell", bundle: nil), forCellReuseIdentifier: "MessageFiveTableViewCell")
        self.messagesTableView.register(UINib(nibName: "MessageSixTableViewCell", bundle: nil), forCellReuseIdentifier: "MessageSixTableViewCell")
        self.onlineCollectionView.register(UINib(nibName: "OnlinePersonCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "OnlinePersonCollectionViewCell")
        self.onlineCollectionView.register(UINib(nibName: "OnlinePersonTwoCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "OnlinePersonTwoCollectionViewCell")
        self.onlineCollectionView.register(UINib(nibName: "OnlinePersonThreeCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "OnlinePersonThreeCollectionViewCell")
    }
